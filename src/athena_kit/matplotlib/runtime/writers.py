...
from athena_kit.matplotlib.runtime.artifact import FigureArtifact, WritableArtifact
...
class BaseWriter[TValue](ABC):
    def write(
        self, figure: Figure, *, filename: str | None = None, options: SaveFigureOptions | None
    ) -> WriteResult[TValue]:
