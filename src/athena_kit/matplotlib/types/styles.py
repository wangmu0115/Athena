...
这些值并不直接对应某一个具体字体文件，Matplotlib 会根据当前配置，如 `font.sans-serif`
在系统已安装字体中依次查找并匹配可用字体。
...
type LegendLocation = Literal[
    "auto", "top", "bottom", "left", "right", "top_left", "top_right", "bottom_left", "bottom_right", "center"
]
